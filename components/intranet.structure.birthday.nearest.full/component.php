...
$arParams['DATE_INTERVAL'] = intval($arParams['DATE_INTERVAL']);
...
else
{
	...
	$dbUsers = CUser::GetList($by = array("CURRENT_BIRTHDAY"=>"asc", "LAST_NAME"=>"asc"), $order = "asc", $arFilter, array('SELECT' => array('UF_*'), 'NAV_PARAMS' => $arNavParams));
...
//			continue;
		...
		///////////////////////////////////////////////////////////
		if ( $arParams['DATE_INTERVAL']>0 && (date("y").$arUser['arBirthDate']['MM'].$arUser['arBirthDate']['DD'] > date("ymd", strtotime("+".$arParams['DATE_INTERVAL']." day"))) ){
			break;
		}
