...
class ExportPaymentResponseList
{
    const IBLOCK_CODE = 'gis-gmp-export-payment-response';
    public array $items;
    ...
    public static function addItem($params): array
    {
        ...
        $fields = [
            'IBLOCK_ID' => RestHelper\Iblock::getIblockIdByCode(ExportPaymentResponseList::IBLOCK_CODE),
        ...
        $object = new ExportPaymentResponseList();
    ...
    {
        $preparedProps = [];
        $schema = (RestHelper\Options::getMapFromOptions('schema_exportpaymentresponsetlist'));
