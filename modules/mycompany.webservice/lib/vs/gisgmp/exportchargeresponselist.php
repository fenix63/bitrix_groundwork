...
class ExportChargeResponseList
{
    const IBLOCK_CODE = 'gis-gmp-export-charge-response';
    public array $items;
    ...
    public static function addItem($params): array
    {
        ...
        $fields = [
            'IBLOCK_ID' => RestHelper\Iblock::getIblockIdByCode(ExportChargeResponseList::IBLOCK_CODE),
        ...
        $object = new ExportChargeResponseList();
