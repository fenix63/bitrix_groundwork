...
class ExportPaymentRequestList
{
    const IBLOCK_CODE = 'gis-gmp-export-payment-request';
    public array $items;
    ...
    public static function addItem($params): array
    {
        ...
        $fields = [
            'IBLOCK_ID' => RestHelper\Iblock::getIblockIdByCode(ExportPaymentRequestList::IBLOCK_CODE),
            'PROPERTY_VALUES' => $props,
            'NAME' => $params["exportpaymentrequestname"],//Название элемента инфоблока
            'ACTIVE' => 'Y'
        ];
        ...
        $object = new ExportPaymentRequestList();
    ...
    {
        $preparedProps = [];
        $schema = (RestHelper\Options::getMapFromOptions('schema_exportpaymentrequestlist'));
