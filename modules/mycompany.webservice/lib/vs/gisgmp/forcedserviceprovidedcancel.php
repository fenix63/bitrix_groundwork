...
class ForcedServiceProvidedCancel implements RequestSender
{
    ...
    private function createRequest(){
        ...
        >
            <ns0:AnnulmentServiceProvided>
                <ns0:PaymentDataID paymentId="'.$this->paymentId.'"/>
            </ns0:AnnulmentServiceProvided>
